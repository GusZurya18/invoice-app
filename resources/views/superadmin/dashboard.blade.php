    ...
    <div class="min-h-screen p-6">
        ...
        <div class="bg-white rounded-3xl shadow-lg p-8 mb-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p class="text-gray-600">Berikut adalah overview bisnis komprehensif untuk membantu Anda membuat
                        keputusan strategis dan laporan keuangan</p>
                </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="relative">
                        <select id="yearFilter"
                            class="appearance-none px-4 py-2.5 pr-10 border-2 border-blue-500 rounded-xl font-semibold text-gray-700 bg-white focus:ring-4 focus:ring-blue-200 focus:border-blue-600 transition-all cursor-pointer">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div class="bg-white rounded-3xl shadow-lg p-6">
                ...
                <p class="text-blue-600 text-sm font-semibold">{{ $paidInvoices }}/{{ $totalInvoices }} invoice</p>
            </div>
            ...
            <div class="bg-white rounded-3xl shadow-lg p-6">
                ...
                <p class="text-3xl font-bold text-gray-900 mb-2">Rp
                    {{ number_format($totalRevenueYTDAfterTax, 0, ',', '.') }}</p>
