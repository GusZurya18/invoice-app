        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-blue-100">Kelola dan pantau semua tugas yang diberikan kepadamu</p>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-md hover:shadow-lg transition-shadow">
                    ...
                    <h3 class="text-3xl font-bold text-gray-900 mb-1">{{ $tasks->where('status', 'in_progress')->count() }}
                    </h3>
            ...
            <div class="bg-white rounded-3xl shadow-xl p-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
                    @foreach ($tasks as $task)
                        <div
                            class="bg-gray-50 rounded-xl hover:shadow-md transition-all duration-300 border border-gray-200 overflow-hidden group hover:border-blue-200">
                            <div class="p-5">
                                <!-- Header -->
                                <div class="mb-4">
                                    <h3
                                        class="text-lg font-bold text-gray-800 group-hover:text-blue-600 transition-colors mb-2 line-clamp-1">
                                        {{ $task->title }}
                                    </h3>
                                    ...
                                    <div class="flex items-center gap-2 flex-wrap">
                                        <span
                                            class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg font-medium text-xs {{ $task->status == 'done'
                                                ? 'bg-green-100 text-green-700'
                                                : ($task->status == 'in_progress'
                                                    ? 'bg-blue-100 text-blue-700'
                                                    : 'bg-orange-100 text-orange-700') }}">
                                            <span
                                                class="w-1.5 h-1.5 rounded-full {{ $task->status == 'done'
                                                    ? 'bg-green-500'
                                                    : ($task->status == 'in_progress'
                                                        ? 'bg-blue-500'
                                                        : 'bg-orange-500') }}"></span>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <form action="{{ route('tasks.update.status', $task) }}" method="POST"
                                        ...
                                        <select name="status" onchange="this.form.submit()"
                                            class="w-full px-3 py-2 text-sm rounded-lg border-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all cursor-pointer font-medium {{ $task->status == 'done'
                                    ...
                                    <a href="{{ route('tasks.show', $task) }}"
                                        class="inline-flex items-center justify-center p-2 bg-gradient-to-r from-blue-600 to-blue-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-blue-700 transform hover:scale-105 transition-all shadow-sm">
