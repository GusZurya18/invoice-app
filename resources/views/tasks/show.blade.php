...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 py-8 px-4">
        <div class="max-w-6xl mx-auto">
            ...
            @if (session('success'))
                <div
                    class="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-6 py-4 rounded-2xl mb-6 shadow-lg animate-fade-in flex items-center gap-3">
            ...
            <div class="grid lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <!-- Task Header Card -->
                    <div
                        class="bg-white rounded-3xl shadow-xl p-8 border border-blue-100 hover:shadow-2xl transition-shadow">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1">
                                <div class="mb-3">
                                    <h1
                                        class="text-3xl font-bold bg-gradient-to-r from-blue-600 to-blue-600 bg-clip-text text-transparent">
                                        {{ $task->title }}
                                    </h1>
                                </div>
                                <div class="flex items-center gap-2 text-gray-600">
                                    <span class="text-sm font-medium">Dibuat oleh:</span>
                                    <span class="text-sm font-semibold text-blue-600">{{ $task->creator?->name }}</span>
                                </div>
                            </div>
                            <div class="bg-gradient-to-br from-blue-100 to-blue-100 rounded-2xl px-4 py-2 h-fit">
                        ...
                        <div class="grid sm:grid-cols-3 gap-4 mb-6">
                            ...
                            <div class="bg-gradient-to-br from-blue-50 to-cyan-50 p-4 rounded-xl border border-blue-200">
                                ...
                                <p class="text-sm font-bold text-gray-800">
                                    {{ \Carbon\Carbon::parse($task->start_date)->format('d M Y') }}</p>
                            </div>
...
$priorityColor = match($task->priority) {
                    ...
                    <div class="bg-white rounded-3xl shadow-xl p-8 border border-blue-100">
                        ...
                        @if ($task->files->count() > 0)
                            <div class="grid sm:grid-cols-2 gap-4 mb-6">
                                @foreach ($task->files as $f)
                                    <div
                                        class="group relative bg-gradient-to-br from-blue-50 to-blue-50 p-4 rounded-xl border border-blue-200 hover:shadow-lg transition-all hover:scale-[1.02]">
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <a target="_blank" href="{{ asset('storage/' . $f->file_path) }}"
                                                    class="text-blue-600 hover:text-blue-700 font-medium text-sm block truncate">
                                                    {{ basename($f->file_path) }}
                                                </a>
                                                <form action="{{ route('tasks.files.destroy', $f) }}" method="POST"
                                                    class="mt-2">
                                                    @csrf @method('DELETE')
                                                    <button
                                                        class="text-red-500 hover:text-red-600 text-xs font-medium flex items-center gap-1 transition-colors"
                        ...
                        <!-- Upload Form -->
                        <div
                            class="bg-gradient-to-br from-blue-100 to-blue-100 p-6 rounded-2xl border-2 border-dashed border-blue-300">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <label class="flex-1">
                                        <input type="file" name="file" required
                                            class="block w-full text-sm text-gray-600 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-600 file:text-white hover:file:bg-blue-700 file:cursor-pointer cursor-pointer">
                                    </label>
                                </div>
                                <button type="submit"
                                    class="w-full bg-gradient-to-r from-blue-600 to-blue-600 hover:from-blue-700 hover:to-blue-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2">
                    ...
                    <div class="bg-white rounded-3xl shadow-xl p-8 border border-blue-100">
                        <div class="flex items-center gap-3 mb-6">
                            ...
                            <span class="ml-auto bg-blue-100 text-blue-600 text-sm font-semibold px-3 py-1 rounded-full">
                                {{ $task->comments->count() }}
                            </span>
                        </div>
                        ...
                        <div class="space-y-4 mb-6 max-h-[500px] overflow-y-auto pr-2 custom-scrollbar">
                            @forelse($task->comments as $c)
                                <div
                                    class="bg-gradient-to-br from-blue-50 to-blue-50 p-5 rounded-2xl border border-blue-100 hover:shadow-md transition-shadow">
                                    <div class="flex items-start justify-between mb-3">
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-500 rounded-full flex items-center justify-center text-white font-bold">
                                            ...
                                            <div>
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <span
                                                        class="text-xs px-2 py-1 rounded-full font-medium {{ $c->user->role == 'admin' ? 'bg-red-100 text-red-600' : 'bg-blue-100 text-blue-600' }}">
                                        ...
                                        @if (auth()->id() === $c->user_id)
                                            <form action="{{ route('tasks.comments.destroy', $c) }}" method="POST"
                                                onsubmit="return confirm('Yakin ingin menghapus komentar ini?')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="text-red-500 hover:text-red-600 transition-colors p-2 hover:bg-red-50 rounded-lg">
                            ...
                            @empty
                                <div class="text-center py-12 text-gray-400">
                                    <svg class="w-20 h-20 mx-auto mb-3 text-gray-300" fill="none"
                                        stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z">
                                        </path>
                        ...
                        <form action="{{ route('tasks.comments.store', $task) }}" method="POST"
                            class="bg-gradient-to-br from-blue-100 to-blue-100 p-6 rounded-2xl border border-blue-200">
                            @csrf
                            <div class="mb-4">
                                <textarea name="comment" rows="3"
                                    class="w-full border-2 border-blue-200 p-4 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none"
                ...
                <div class="lg:col-span-1">
                    <div
                        class="bg-gradient-to-br from-blue-600 to-blue-600 rounded-3xl shadow-xl p-8 text-white sticky top-6">
                        <div class="text-center mb-6">
                            ...
                            <p class="text-blue-100 text-sm">Detail informasi task</p>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                                <div class="flex items-center gap-3 mb-2">
                                    ...
                                    <span class="text-sm font-medium text-blue-100">Total Files</span>
                                </div>
                            ...
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                                <div class="flex items-center gap-3 mb-2">
                                    ...
                                    <span class="text-sm font-medium text-blue-100">Total Komentar</span>
                                </div>
                            ...
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                                <div class="flex items-center gap-3 mb-2">
                                    ...
                                    <span class="text-sm font-medium text-blue-100">Dibuat</span>
                                </div>
