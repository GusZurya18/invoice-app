...
<head>
    ...
    <title>Hubungi Kami - InvoicePro</title>
...
<body>
                ...
                <div class="bg-white rounded-2xl shadow-2xl p-8">
                    ...
                    <div class="flex items-center justify-center mb-6">
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="text-xl font-bold text-blue-600">InvoicePro</span>
                        </div>
                    </div>
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="text-gray-600">
                            Sampaikan saran atau masukan Anda untuk membantu kami mengembangkan aplikasi invoice ini.
                        </p>
                    </div>
                    ...
                    <form class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="fullName" name="fullName" placeholder="Contoh: John Doe"
                            ...
                            <div class="mb-6">
                                ...
                                <input type="email" id="email" name="email" placeholder="emailanda@gmail.com"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
                                    required>
                            </div>
                        ...
                        <!-- Submit Button -->
                        <button type="submit"
                            class="w-full bg-blue-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-blue-700 transition-colors shadow-lg flex items-center justify-center space-x-2">
    ...
    <div class="md:hidden fixed inset-0 bg-blue-900 bg-opacity-95 z-50 hidden" id="mobile-menu">
        <div class="flex flex-col items-center justify-center h-full space-y-8">
            ...
            <a href="#" class="text-blue-200 text-2xl font-medium">Kontak</a>
