...
@section('content')
    ...
    <div
        class="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 min-h-screen flex items-center justify-center py-12 px-4">
        <div class="w-full max-w-2xl bg-white rounded-2xl shadow-xl p-8">
            ...
            {{-- Title --}}
            <h2 class="text-2xl font-bold text-blue-700 text-center mb-8">Edit Product</h2>
            ...
            <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data"
                id="productForm" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <div id="drop-area"
                        ...
                        @if ($product->photo)
                            <img id="preview" src="{{ asset('storage/' . $product->photo) }}"
                                class="mx-auto mt-4 max-h-48 rounded-lg">
                        @else
