...
<div class="bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 min-h-screen flex items-center justify-center py-12 px-4">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
        ...
        {{-- Title --}}
        <h2 class="text-2xl font-bold text-purple-700 text-center mb-8">Add New Category</h2>
        ...
        {{-- Form --}}
        <form action="{{ route('categories.store') }}" method="POST" id="categoryForm" class="space-y-6">
            @csrf
