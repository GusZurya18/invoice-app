                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <button type="button" id="add-customer-btn"
                                            class="px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-lg transition-all duration-200 font-medium shadow-md hover:shadow-lg flex items-center gap-2 whitespace-nowrap">
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">Can't find the customer? Click "New Customer" to
                                        add one</p>
                                </div>
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="relative">
                                        <input type="number" id="discount" name="discount_percent" value="0"
                                            min="0" max="100" step="0.01"
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                                        <span
                                            class="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-500 font-medium">%</span>
                                    </div>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="number" id="tax_rate" name="tax_rate"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                                        value="{{ old('tax_rate', $company->tax_rate) }}" min="0" max="100"
                                        step="0.01">
                                ...
                                <table class="w-full" id="items-table">
                                    <thead>
                                        <tr class="border-b border-gray-200">
                                            ...
                                            <th class="text-center py-3 px-2 text-sm font-semibold text-gray-700 w-24">Qty
                                            </th>
                                            <th class="text-right py-3 px-2 text-sm font-semibold text-gray-700 w-32">Unit
                                                Price</th>
                                            <th class="text-right py-3 px-2 text-sm font-semibold text-gray-700 w-32">Total
                                            </th>
                                            <th class="w-12"></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr class="item-row border-b border-gray-100 hover:bg-gray-50">
                                            ...
                                            <td class="py-3 px-2 text-right unit-price font-medium text-gray-700 text-sm">
                                                Rp 0</td>
                                            <td
                                                class="py-3 px-2 text-right line-total font-semibold text-gray-900 text-sm">
                                                Rp 0</td>
                                            <td class="py-3 px-2 text-center">
                                                <button type="button"
                                                    class="remove-row p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors">
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="notes" rows="4" placeholder="Add any additional notes or comments about this invoice..."
                    ...
                    <div class="lg:col-span-1">
                        <div class="sticky top-6">
                            <div
                                class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl shadow-lg border border-blue-200 p-6">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <!-- Discount Percent -->
                                    <div class="flex justify-between items-center py-2" id="discount-percent-row"
                                        style="display: none;">
                                        <span class="text-gray-600">Discount</span>
                                        <span id="discount-percent-display"
                                            class="text-orange-600 font-semibold">0%</span>
                                    </div>

                                    <!-- Discount Amount -->
                                    <div class="flex justify-between items-center py-2" id="discount-amount-row"
                                        style="display: none;">
        ...
        (function() {
            ...
            function recalc() {
                ...
                document.querySelectorAll('#items-table tbody tr').forEach(r => {
                    ...
                    let price = parseFloat(r.querySelector('.product-select').selectedOptions[0]?.dataset
                        .price) || 0;
