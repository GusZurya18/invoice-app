...
@section('content')
    <div class="w-full px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
        ...
        {{-- Header Section --}}
        <div
            class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 lg:mb-6 gap-3 animate-fade-in">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 lg:gap-5 mb-4 lg:mb-6">
            {{-- Total Invoice Card --}}
            <div class="stat-card bg-white rounded-lg lg:rounded-2xl p-3 sm:p-4 lg:p-5 shadow-sm hover:shadow-md transition-all duration-300"
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center sm:justify-between gap-2">
                    <div class="min-w-0 flex-1 w-full">
                        ...
                        <p class="text-lg sm:text-xl lg:text-3xl font-bold text-gray-900 counter-number"
                            data-target="{{ $totalInvoices }}">0</p>
                    </div>
                    <div
                        class="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-blue-500 rounded-lg lg:rounded-xl flex items-center justify-center flex-shrink-0 icon-float">
            ...
            <div class="stat-card bg-white rounded-lg lg:rounded-2xl p-3 sm:p-4 lg:p-5 shadow-sm hover:shadow-md transition-all duration-300"
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center sm:justify-between gap-2">
                    <div class="min-w-0 flex-1 w-full">
                        ...
                        <p class="text-lg sm:text-xl lg:text-3xl font-bold text-gray-900 counter-number"
                            data-target="{{ $paidInvoices }}">0</p>
                    </div>
                    <div
                        class="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-green-500 rounded-lg lg:rounded-xl flex items-center justify-center flex-shrink-0 icon-float">
                        <svg class="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="stat-card bg-white rounded-lg lg:rounded-2xl p-3 sm:p-4 lg:p-5 shadow-sm hover:shadow-md transition-all duration-300"
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center sm:justify-between gap-2">
                    <div class="min-w-0 flex-1 w-full">
                        ...
                        <p class="text-lg sm:text-xl lg:text-3xl font-bold text-gray-900 counter-number"
                            data-target="{{ $pendingInvoices }}">0</p>
                    </div>
                    <div
                        class="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-orange-500 rounded-lg lg:rounded-xl flex items-center justify-center flex-shrink-0 icon-float">
                        <svg class="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path
            ...
            <div class="stat-card bg-white rounded-lg lg:rounded-2xl p-3 sm:p-4 lg:p-5 shadow-sm hover:shadow-md transition-all duration-300"
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center sm:justify-between gap-2">
                    <div class="min-w-0 flex-1 w-full">
                        ...
                        <p class="text-lg sm:text-xl lg:text-3xl font-bold text-gray-900 counter-number"
                            data-target="{{ $unpaidInvoices }}">0</p>
                    </div>
                    <div
                        class="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-red-500 rounded-lg lg:rounded-xl flex items-center justify-center flex-shrink-0 icon-float">
                        <svg class="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,6A1.5,1.5 0 0,1 13.5,7.5A1.5,1.5 0 0,1 12,9A1.5,1.5 0 0,1 10.5,7.5A1.5,1.5 0 0,1 12,6M12,17C10.5,17 9.27,16.12 8.75,14.87L10.07,14.41C10.36,15.11 11.1,15.5 12,15.5C12.9,15.5 13.64,15.11 13.93,14.41L15.25,14.87C14.73,16.12 13.5,17 12,17Z" />
                        </svg>
                    </div>
                </div>
            </div>
        ...
        {{-- Controls Section --}}
        <div class="bg-white rounded-lg lg:rounded-2xl p-3 sm:p-4 lg:p-5 mb-4 lg:mb-6 shadow-sm animate-slide-up"
            style="animation-delay: 0.5s">
            {{-- Mobile Layout: Stacked --}}
            <div class="flex flex-col gap-3 lg:hidden">
                {{-- Create Button --}}
                <a href="{{ route('admin.invoices.create') }}"
                    class="btn-animated inline-flex items-center justify-center px-4 py-2.5 text-sm bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-all duration-300">
                ...
                <div class="overflow-x-auto -mx-3 px-3 hide-scrollbar">
                    <div class="inline-flex bg-gray-100 rounded-lg p-1 min-w-full">
                        <button
                            class="filter-tab px-3 py-2 text-xs font-medium rounded-md transition-all duration-300 active whitespace-nowrap flex-1"
                            data-filter="all">All</button>
                        <button
                            class="filter-tab px-3 py-2 text-xs font-medium rounded-md transition-all duration-300 whitespace-nowrap flex-1"
                            data-filter="paid">Paid</button>
                        <button
                            class="filter-tab px-3 py-2 text-xs font-medium rounded-md transition-all duration-300 whitespace-nowrap flex-1"
                            data-filter="unpaid">Unpaid</button>
                        <button
                            class="filter-tab px-3 py-2 text-xs font-medium rounded-md transition-all duration-300 whitespace-nowrap flex-1"
                ...
                <div class="flex gap-2">
                    ...
                    <div class="relative flex-1">
                        ...
                        <input type="text" id="searchInput"
                            class="w-full pl-10 pr-3 py-2 text-sm bg-gray-100 rounded-lg border-0 focus:ring-2 focus:ring-blue-500 text-gray-900 placeholder-gray-500 transition-all duration-300"
                            placeholder="Cari invoice...">
                    </div>

                    {{-- Date Filter --}}
                    <input type="month" id="dateFilterMobile"
                        class="px-3 py-2 text-sm bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium rounded-lg transition-all duration-300 border-0 focus:ring-2 focus:ring-blue-500 flex-shrink-0">
                </div>
            </div>
            ...
            <div class="hidden lg:flex items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.invoices.create') }}"
                        class="btn-animated inline-flex items-center justify-center px-4 py-2.5 text-sm bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-all duration-300 flex-shrink-0">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="inline-flex bg-gray-100 rounded-lg p-1">
                        <button
                            class="filter-tab px-4 py-2 text-sm font-medium rounded-md transition-all duration-300 active whitespace-nowrap"
                            data-filter="all">All</button>
                        <button
                            class="filter-tab px-4 py-2 text-sm font-medium rounded-md transition-all duration-300 whitespace-nowrap"
                            data-filter="paid">Paid</button>
                        <button
                            class="filter-tab px-4 py-2 text-sm font-medium rounded-md transition-all duration-300 whitespace-nowrap"
                            data-filter="unpaid">Unpaid</button>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="searchInputBottom"
                            class="w-64 pl-10 pr-3 py-2 text-sm bg-gray-100 rounded-lg border-0 focus:ring-2 focus:ring-blue-500 text-gray-900 placeholder-gray-500 transition-all duration-300"
                            placeholder="Cari invoice...">
                    </div>
        ...
        <form id="bulkDeleteForm" action="{{ route('admin.invoices.bulk-delete') }}" method="POST"
            style="display: none;">
            @csrf
            @method('DELETE')
        ...
        {{-- Table Section --}}
        <div class="bg-white rounded-lg lg:rounded-2xl shadow-sm overflow-hidden animate-slide-up"
            ...
            <div class="bg-gray-50 px-3 sm:px-4 lg:px-5 py-3 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    ...
                    <div id="bulkActions" class="hidden flex items-center gap-2">
                        ...
                        <button id="clearSelection" type="button"
                            class="text-xs text-gray-600 hover:text-gray-800 font-medium transition-colors duration-200">Clear</button>
                    </div>
                </div>
            </div>
                    ...
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-3 py-3 text-left">
                                <input type="checkbox"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded transition-all duration-200">
                            </th>
                            ...
                            <th
                                class="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase hidden xl:table-cell">
                                Diskon</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200" id="tableBody">
                        @forelse($invoices as $inv)
                            <tr class="table-row-animated hover:bg-gray-50 transition-all duration-200"
                                ...
                                data-code="{{ strtolower($inv->code) }}" data-status="{{ $inv->status }}"
                                data-paid="{{ $inv->paid_status }}"
                                data-date="{{ $inv->start_date ? $inv->start_date->format('Y-m') : '' }}">
                                <td class="px-3 py-3">
                                    <input type="checkbox"
                                        class="row-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded transition-all duration-200"
                                        data-id="{{ $inv->id }}">
                                </td>
                                ...
                                <td class="px-3 py-3">
                                    ...
                                    @elseif($inv->due_date && now()->gt($inv->due_date))
                                        <span
                                            class="inline-flex items-center px-2 py-0.5 text-xs font-medium rounded-full bg-red-100 text-red-800">
                                            Overdue
                                        </span>
                                    @else
                                        <span
                                            class="inline-flex items-center px-2 py-0.5 text-xs font-medium rounded-full bg-yellow-100 text-yellow-800">
                                            Pending
                                        </span>
                                    @endif
                                </td>
                                <td class="px-3 py-3">
                                    <div class="flex gap-1">
                                        <a href="{{ route('admin.invoices.show', $inv) }}"
                                            class="action-btn w-7 h-7 bg-green-500 hover:bg-green-600 text-white rounded-md flex items-center justify-center transition-all duration-200"
                                            title="View">
                                        ...
                                        <a href="{{ route('admin.invoices.edit', $inv) }}"
                                            class="action-btn w-7 h-7 bg-yellow-500 hover:bg-yellow-600 text-white rounded-md flex items-center justify-center transition-all duration-200"
                                            title="Edit">
                                            <svg class="w-3 h-3" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <button type="button"
                                            class="delete-btn action-btn w-7 h-7 bg-red-500 hover:bg-red-600 text-white rounded-md flex items-center justify-center transition-all duration-200"
                                            data-invoice-id="{{ $inv->id }}"
                                            data-invoice-code="{{ $inv->code }}"
                                            data-url="{{ route('admin.invoices.destroy', $inv) }}" title="Delete">
                                            <svg class="w-3 h-3" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16">
                                        ...
                                        <a href="{{ route('admin.invoices.pdf', $inv) }}"
                                            class="action-btn w-7 h-7 bg-blue-500 hover:bg-blue-600 text-white rounded-md flex items-center justify-center transition-all duration-200"
                        ...
                        <div class="mobile-card p-4 hover:bg-gray-50 transition-all duration-200"
                            ...
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex items-start gap-2 flex-1 min-w-0">
                                    <input type="checkbox"
                                        class="row-checkbox mt-1 w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded flex-shrink-0 transition-all duration-200"
                                        data-id="{{ $inv->id }}">
                                ...
                                @if ($inv->paid_status === 'done')
                                    <span
                                        class="inline-flex items-center px-2 py-0.5 text-xs font-medium rounded-full bg-green-100 text-green-800 flex-shrink-0 ml-2">
                                        <svg class="w-2.5 h-2.5 mr-1" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" />
                                        </svg>
                                        Done
                                ...
                                @elseif($inv->due_date && now()->gt($inv->due_date))
                                    <span
                                        class="inline-flex items-center px-2 py-0.5 text-xs font-medium rounded-full bg-red-100 text-red-800 flex-shrink-0 ml-2">
                                        Overdue
                                    </span>
                                @else
                                    <span
                                        class="inline-flex items-center px-2 py-0.5 text-xs font-medium rounded-full bg-yellow-100 text-yellow-800 flex-shrink-0 ml-2">
                                        Pending
                                    </span>
                                @endif
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-2 mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-medium text-gray-900">
                                        {{ $inv->due_date ? $inv->due_date->format('d/m/y') : '-' }}</p>
                                </div>
                                <div>
                            ...
                            <div class="flex gap-2">
                                <a href="{{ route('admin.invoices.show', $inv) }}"
                                    class="btn-animated flex-1 flex items-center justify-center px-3 py-2 bg-green-500 hover:bg-green-600 text-white text-xs font-medium rounded-lg transition-all duration-300">
                                ...
                                <a href="{{ route('admin.invoices.edit', $inv) }}"
                                    class="btn-animated flex-1 flex items-center justify-center px-3 py-2 bg-yellow-500 hover:bg-yellow-600 text-white text-xs font-medium rounded-lg transition-all duration-300">
                                    <svg class="w-3.5 h-3.5 mr-1.5" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z">
                                ...
                                <a href="{{ route('admin.invoices.pdf', $inv) }}"
                                    class="btn-animated w-10 h-10 flex items-center justify-center bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-all duration-300"
                                ...
                                <button type="button"
                                    class="delete-btn btn-animated w-10 h-10 bg-red-500 hover:bg-red-600 text-white rounded-lg flex items-center justify-center transition-all duration-300"
                                    data-invoice-id="{{ $inv->id }}" data-invoice-code="{{ $inv->code }}"
                                    data-url="{{ route('admin.invoices.destroy', $inv) }}" title="Delete">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16">
            ...
            <div class="bg-white px-3 sm:px-4 lg:px-5 py-3 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
                    <p class="text-xs text-gray-700 text-center sm:text-left">
                        <span id="showingFrom">1</span>-<span id="showingTo">10</span> dari <span
                            id="totalItems">{{ $invoices->total() ?? 0 }}</span>
                    </p>

                    <div class="flex items-center gap-1">
                        <button id="prevBtn"
                            class="px-2 py-1 text-sm text-gray-500 bg-white border border-gray-300 rounded-md hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="p-6 text-center">
                ...
                <div class="flex gap-3 justify-center">
                    <button id="cancelDelete" type="button"
                        class="btn-animated px-6 py-2.5 bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium rounded-lg transition-all duration-300">
                        Cancel
                    </button>
                    <button id="confirmDelete" type="button"
                        class="btn-animated px-6 py-2.5 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-all duration-300">
                        Delete
                    </button>
                </div>
            </div>
    ...
    <div id="bulkDeleteModal"
        ...
        <div class="modal-content bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all">
            <div class="p-6 text-center">
                ...
                <div class="flex gap-3 justify-center">
                    <button id="cancelBulkDelete" type="button"
                        class="btn-animated px-6 py-2.5 bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium rounded-lg transition-all duration-300">
                        Cancel
                    </button>
                    <button id="confirmBulkDelete" type="button"
                        class="btn-animated px-6 py-2.5 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-all duration-300">
                        Delete
                    </button>
                </div>
        ...
        <div class="modal-content bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all">
            <div class="p-6 text-center">
                ...
                <button id="closeSuccess" type="button"
                    class="btn-animated px-8 py-2.5 bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium rounded-lg transition-all duration-300">
                    Close
                </button>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function init() {
                ...
                allMobileCardsArray = Array.from(mobileCardsContainer?.querySelectorAll(
                    '.mobile-card:not(#emptyStateMobile)') || []);
                updatePagination();
