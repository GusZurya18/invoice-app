...
<body class="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 min-h-screen">
        ...
        <div
            ...
            <nav class="space-y-2">
                <a href="{{ route('dashboard') }}"
                    class="nav-item flex items-center px-4 py-3 {{ request()->routeIs('dashboard') ? 'text-white bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800' : 'bg-gray-200 text-black/80 hover:text-white/80 hover:bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800' }} rounded-lg transition-colors">
                ...
                {{-- <a href="{{ route('invoices.index') }}"
                    class="nav-item flex items-center px-4 py-3 {{ request()->routeIs('invoices.*') ? 'text-white bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800' : 'bg-gray-200 text-black/80 hover:text-white/80 hover:bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800' }} rounded-lg transition-colors">
                    <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                ...
                {{-- <a href="{{ route('categories.index') }}" class="nav-item flex items-center px-4 py-3 {{ request()->routeIs('categories.*') ? 'text-white bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800' : 'bg-gray-200 text-black/80 hover:text-white/80 hover:bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800' }} rounded-lg transition-colors">
                    <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                ...
                {{-- <a href="{{ route('products.index') }}" class="nav-item flex items-center px-4 py-3 {{ request()->routeIs('products.*') ? 'text-white bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800' : 'bg-gray-200 text-black/80 hover:text-white/80 hover:bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800' }} rounded-lg transition-colors">
                    <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
   ...
   {{ request()->routeIs('tasks.*')
       ? 'text-white bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800'
       : 'bg-gray-200 text-black/80 hover:text-white/80 hover:bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800' }} rounded-lg transition-colors">
